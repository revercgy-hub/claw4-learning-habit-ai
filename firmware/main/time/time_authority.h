...
enum class TimeQuality { Unsynced, Synced, Stale };
...
struct TimeAuthorityConfig {
  ...
  std::optional<int64_t> drift_upper_bound_ppm;
};
...
struct TimeStatus {
  ...
  std::optional<int64_t> uncertainty_ms;
  bool holdover_window = false;
