...
> 2026-09-23 correction: clipping interpretations below are **SUPERSEDED**. The firmware emitted `clipped=0` from a counter that was not incremented after PCM normalization; this report does not establish analog or ADC clipping behavior. See [`V6_M0_CANDIDATE19_AUDIO_METRIC_REPORT.md`](V6_M0_CANDIDATE19_AUDIO_METRIC_REPORT.md).
