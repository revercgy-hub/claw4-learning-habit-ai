...
- NAS Compose SHA-256：`84182bcc943613211a2e121eac347f25e8a114a4cdbf273a818732372e4fcf43`；NAS `data/.config.yaml` SHA-256：`a2a67e21592c755d1cdadc5cf2af42d981805843f59ab03193c95cdf709b55fe`，与仓库模板逐字节一致。配置不含凭据。
...
3. NAS 和工作机访问 `http://192.168.3.100:8003/xiaozhi/ota/` 均返回 HTTP 200，内容给出 `ws://192.168.3.100:8000/xiaozhi/v1/`；工作机到 8000/8003 TCP 均可达，WebSocket Upgrade 返回 `101 Switching Protocols`。
