...
| M1-DEV-01 | IN_PROGRESS | Luna 在 `db97ad5994f3ee0c5e1fb4deb2fa4fa2ec3ee1ee` 基线开发 20 轮证据验证工具；host/tooling only |
...
| M1 | NAS 连续语音 20 轮 | Astra/Sol/Luna 按任务拆分 | IN_PROGRESS (HOST PREP ONLY) | 用户已明确要求开始下一阶段开发；M0 仍 CHANGES_REQUIRED；NAS部署/真机20轮尚未开始；旧 relay 学习闭环不计入M1 |
