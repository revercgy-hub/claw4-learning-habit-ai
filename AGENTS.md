...
2026-09-05 AF0/AF1a 更新：统一 `tools/dev/run-app-first-gate.ps1 -Mode Quick` 与真实 `LearningApp` Virtual Device runner 均 PASS；AF1a 新增 target-portable challenge/auth/today/events/ACK JSON codec，host unit 12/12、interface 34/34+3/3+1/1 PASS，提交 `ea3afb2`。AF0/AF1a 证据见 `docs/project_management/reports/CODEX_APP_FIRST_AF0_2026-09-05.md` 与 `CODEX_APP_FIRST_AF1A_2026-09-05.md`；活动分支 `codex/app-first-mvp-loop`，下一步 AF1b HTTP relay，暂不连接真机。
