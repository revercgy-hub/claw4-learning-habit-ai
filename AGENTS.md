...
- Bring-up Stage 1 未验收前，真机耦合代码、官方固件集成、设备 LVGL 实机页面、硬件能力声明与发布构建保持 `HOLD`。经用户 2026-09-02 授权，纯主机侧接口、领域契约、Mock Backend 和自动化测试可在隔离工作流分支提前开发，但不得写成真机已验证或直接合入发布基线。
